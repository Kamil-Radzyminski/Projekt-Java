 ...
 * @author Kamil
 */
public class TowarAddMagazynIDClickListener extends AbstractClickAdapter {

    private final GridTowarAdd grid;
    
    public TowarAddMagazynIDClickListener(JTable jtable, JFrame jFrame, GridTowarAdd grid) {
        super(jtable, jFrame);
        this.grid = grid;
    }
