 ...
 * @author Kamil
 */
public class GatunekModifyRodzinaIDClickListener extends AbstractClickAdapter {

    private final GridGatunekModify grid;
    
    public GatunekModifyRodzinaIDClickListener(JTable jtable, JFrame jFrame, GridGatunekModify grid) {
        super(jtable, jFrame);
        this.grid = grid;
    }
