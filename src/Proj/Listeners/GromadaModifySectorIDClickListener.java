 ...
 * @author Kamil
 */
public class GromadaModifySectorIDClickListener extends AbstractClickAdapter {

    private final GridGromadaModify grid;
    
    public GromadaModifySectorIDClickListener(JTable jtable, JFrame jFrame, GridGromadaModify grid) {
        super(jtable, jFrame);
        this.grid = grid;
    }
