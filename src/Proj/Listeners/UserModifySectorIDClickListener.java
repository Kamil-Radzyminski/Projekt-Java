 ...
 * @author Kamil
 */
public class UserModifySectorIDClickListener extends AbstractClickAdapter {

    private final GridUserModify grid;
    
    public UserModifySectorIDClickListener(JTable jtable, JFrame jFrame, GridUserModify grid) {
        super(jtable, jFrame);
        this.grid = grid;
    }
