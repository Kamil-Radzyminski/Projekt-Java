 ...
 * @author Kamil
 */
public class GridRodzinaAdd implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        try {
            ...
            if (zrodlo == Obcy) {
                ...
                RodzinaAddGromadaIDClickListener rodzinaAddGromadaIDClickListener = new RodzinaAddGromadaIDClickListener(jt1, jFrame, this);

                jt1.addMouseListener(rodzinaAddGromadaIDClickListener);
